...
![Golang Version](https://img.shields.io/github/go-mod/go-version/arabian9ts/fairplay-ksm)
![Build Status](https://github.com/arabian9ts/fairplay-ksm/workflows/Test/badge.svg?branch=master)
...
```bash
go get github.com/arabian9ts/fairplay-ksm
```
